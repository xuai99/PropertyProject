...
class myItemizationAdapter extends ArrayAdapter<myItemization>
{
    private static final String TAG = "RentalCalc";

    private OnValueChangedListener _listener;

    myItemizationAdapter(Context context, List<myItemization> items)
    {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent)
    {
        ...
        final myItemization item = getItem(position);
        ...
        holder.deleteIcon.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                myItemizationAdapter.this.remove(myItemizationAdapter.this.getItem(position));
            }
        });
